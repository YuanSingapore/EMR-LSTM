    ...
    for patient in tqdm(patients, desc='Iterating over patients in {}'.format(partition)):
        ...
        for ts_filename in patient_ts_files:
            with open(os.path.join(patient_folder, ts_filename)) as tsfile:
                ...
                print("ts_filename", os.path.join(patient_folder, lb_filename))
                ...
                print("ts_lines header:",header)
                print("ts_lines header:",ts_lines)
...
def main():
    parser = argparse.ArgumentParser(description="Create data for Ventilation prediction task.")
